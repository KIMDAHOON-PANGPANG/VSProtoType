...
| `build/index_25.html` | v0.19.0 — Rush Waves & Spreader(피드백 6건): 강화 웨이브=고속 러시 변종(×1.8) · 리프 88→120 · 중간보스 리프 240(저스트 회피 강제)+쿨 4.5~6.2 · 전염 엘리트(첫 그로기 미처형 시 확률 변이 — 로스터 4종) · 그로기 2.4s · 보상 픽업 개선(근처 스폰·화살표·반경·수명) (**현재 최신**) |
