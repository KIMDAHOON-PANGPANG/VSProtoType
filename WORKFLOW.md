...
| `build/index_27.html` | v0.21.0 — Rhythm & Bounce (FQA S001 판정 반영): 초반 감속 철회+후반 가속(템포) · 강화 웨이브 위협화(물량·burst·러시 2.0·접촉딜↑) · 엘리트 공급 에스컬레이션(eliteMax 5·물결 2~4) · 저스트회피→처형 찬스(쿨 환급+즉시 그로기) · 엘리트 방치 비용↑ · 도끼 은퇴 → 신무기 '튕기는 축구공'(ball) · 육각 오라 버프 (**현재 최신**) |
