...
| `build/index_24.html` | v0.18.0 — Midboss & Punish Rewards(피드백 6건): 차지 무기 방향 고정(불사조) · 카드 설명 3단계 간소화 · 5분 중간보스(광역 리프·처형 2회) · 2분 대량 웨이브+HP 상향+템포 커브(1~2분 카이팅) · 엘리트 3종 로테이션(청소기·격노) · 처형 강화 보상 오브젝트(공용 상시/전용 3회) (**현재 최신**) |
