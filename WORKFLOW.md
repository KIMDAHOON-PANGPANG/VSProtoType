...
| `build/index_26.html` | v0.20.0 — Repel & Two-Phase Rewards: 전용 보상 = 2단계 선택(전용 3종 중 1개 → 공용 중 1개) · 중간보스 떨쳐내기(처형 버팀 기상 시 확장 파동 넉백, 마지막 처형 땐 없음) · 중간보스 HP 1200(+50%) (**현재 최신**) |
